...
//Criand uma dowload com uma lógica: O código começa criando um InputStream a partir da URL fornecida (pdfUrl). O InputStream é utilizado para ler os dados do arquivo PDF diretamente da web.
import java.io.*;
import java.net.URL;
